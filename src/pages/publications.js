...
const Publications = () => {
  ...
  return (
    ...
    >
      ...
      {/* Paper 1 */}
      <div className="container" role="article" aria-labelledby="livetyping-title" style={{ marginBottom: '30px', display: 'flex', alignItems: 'flex-start' }}>
        ...
        <div style={{ fontSize: '16px', color: '#7C7C7C', lineHeight: '1.4', marginTop: '1vh', marginLeft: '10px', textAlign: 'left' }}>
          <div id="livetyping-title" role="heading" aria-level="3" style={{ marginBottom: '5px', fontWeight: 'inherit' }}>
          ...
          <ul className="links-visual" role="list" aria-label="Resources">
            ...
            <li>
              <span className="sr-only" inert>Code repository for live typing paper</span>
              <a
      ...
      {/* Paper 2 */}
      <div className="container" role="article" aria-labelledby="mrpw-title" style={{ marginBottom: '30px', display: 'flex', alignItems: 'flex-start' }}>
        ...
        <div style={{ fontSize: '16px', color: '#7C7C7C', lineHeight: '1.4', marginTop: '1vh', marginLeft: '10px', textAlign: 'left' }}>
          <div id="mrpw-title" role="heading" aria-level="3" style={{ marginBottom: '5px', fontWeight: 'inherit' }}>
      ...
      <div className="container" role="article" aria-labelledby="paper3-title" style={{ marginBottom: '60px', display: 'flex', alignItems: 'flex-start' }}>
        ...
        <div style={{ fontSize: '16px', color: '#7C7C7C', lineHeight: '1.4', marginTop: '1vh', marginLeft: '10px', textAlign: 'left' }}>
          ...
          <aside className="reader-inline" aria-hidden="true" inert>
