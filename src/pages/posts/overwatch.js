    ...
    >
      ...
      <div >
        ...
        >
          ...
          <br />
          <br />
          As someone who does HCI research, my relationship with video games has always been double-edged. On one hand, I'm fascinated by the chaotic complexity and the immersive experiences they offer. On the other hand, I'm aware of their design flaws, especially when it comes to the user interface (UI) and user experience (UX). Video games often present a steep learning curve: Overwatch challenges conventional UI/UX principles, demanding that players adjust to its chaotic mess rather than simplifying the experience. This “chaotic mess", however, is part of what makes Overwatch so compelling and adrenaline inducing for me. Each match feels like a complicated rock-paper-scissors game. The interplay between characters, their abilities, and the strategic mindfulness required for team coordination is what makes playing it so fulfilling.
          <br />
          <br />
