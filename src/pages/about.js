...
const About = () => {
  ...
  <span style={{ fontWeight: 'bold', color: '#7C7C7C' }}> Updates </span>
</div>

<div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px', color: '#7C7C7C', fontSize: '16px', fontWeight: '300' }}>
  <div style={{
    backgroundColor: 'rgba(236, 193, 124, 0.3)', // #ECC17C with 30% transparency
    fontWeight: 'bold',
    color: '#ECC17C',
...
<div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px', color: '#7C7C7C', fontSize: '16px', fontWeight: '300' }}>
  ...
  <div>Attended UIST 2023 as a student volunteer and demoed ProactiveAgent for SIC</div>
</div>
