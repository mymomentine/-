    ...
    >
      ...
      <style>
        {`
          ...
          /* Stop iOS Safari from resizing text in landscape */
          html {
            -webkit-text-size-adjust: 100%;
            text-size-adjust: 100%;
          }

          /* Tooltip wrapper must not change font sizing */
          .tooltip {
            position: relative;
            display: inline; /* IMPORTANT: avoids weird iOS sizing */
            cursor: pointer;
            font-size: inherit;
            line-height: inherit;
          }
      ...
      >
        ...
        <div>
          ...
          >
            ...
            <a
              href="https://github.com/momentine"
              target="_self"
              rel="noopener noreferrer"
              aria-label="Visit Yumeng's GitHub profile"
            >
              <FaGithub size={18} />
            </a>
            <a
              href="https://scholar.google.com/citations?hl=en&user=qTFjaQoAAAAJ"
              target="_self"
              rel="noopener noreferrer"
              aria-label="Visit Yumeng's Google Scholar profile"
            >
          ...
          >
            ...
            <span className="tooltip">
              ...
              <span className="tooltiptext">
                Professor of Information and, by courtesy, Computer Science &amp;
            ...
            web experiences. I am also a UX research intern this summer at <strong>Amazon</strong> (more details coming soon).
            ...
            <span className="tooltip">
              ...
              <span className="tooltiptext">
                Associate Professor and Associate Chair of Computer Science at
                Brown University
              </span>
            </span>{" "}
            ...
            <span className="tooltip">
              ...
              <span className="tooltiptext">
                Neuroscientist and Founding Director of the Center for Vision
                Research at Brown University
              </span>
            </span>{" "}
            in the neuroscience department. My B.S. is from{" "}
            <a
            ...
            where I double majored in computer science and psychology.
            <br />
            <br />
            On the side, I enjoy lurking on Discord, skateboarding, loitering at
            grocery stores, sketching{" "}
